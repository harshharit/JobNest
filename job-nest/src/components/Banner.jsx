    ...
    <div className='max-w-screen-2xl container mx-auto xl:px-24 md:py-20 py-14'>
      ...
      <form>
        <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
            <div className='flex md:rounded-s-md rounded shadow-sm ring-1 ring-insert ring gray-300 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/2 w-full'>
            ...
            <div className='flex md:rounded-s-none rounded shadow-sm ring-1 ring-insert ring gray-300 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full'>
            ...
            <button type='submit' className='bg-blue py-2 px-8 text-white md:rouded-s-none rounded'>Search</button>
        </div>
      </form>
    </div>
  )
